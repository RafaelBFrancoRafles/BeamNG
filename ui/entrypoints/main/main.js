  ...
  .controller("AppCtrl", [
    ...
    function (
      ...
      $scope.$on("$stateChangeSuccess", function (event, toState, toParams, fromState, fromParams) {
        ...
        // console.log("ANGULAR-STATE", toState.name, { toState, toParams })
        if (toState.name !== "blank") {
          // call vue if we're supposed to show multiple frameworks at once
          bngVue.gotoGameState(toState.name, {
            params: toParams,
            blankAngularJS: false,
            clickThrough: toState.clickThrough,
            uiAppsShown: toState.uiAppsShown,
          });
        }
