...
;(function(){
	...
	fn.text = function(s){
		if(this.n.childNodes.length === 0) {
			this.empty().n.appendChild(document.createTextNode(s));
		} else {
			this.n.childNodes[0].textContent = s;
		}
		return this;
	}
	...
	fn.attrnv = function(name, value){
		...
		if (value === undefined) return this.n.getAttributeNS(ns, name);
		if (value instanceof U) value = "url(#"+value.n.id+")";
		this.n.setAttributeNS(ns, name, value);
		return this;
	}
