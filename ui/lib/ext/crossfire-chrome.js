...
function scrollCatch(axis, enable) {
  ...
  bngApi.engineLua(`core_input_bindings.setMenuActionEnabled(${enable ? "true" : "false"}, "menu_item_radial_right_x")`);
  bngApi.engineLua(`core_input_bindings.setMenuActionEnabled(${enable ? "true" : "false"}, "menu_item_radial_right_y")`);
