...
C.name = 'Camera Look at Player Vehicle'
C.description = 'Sets the camera rotation to always look at the player vehicle automatically.'
...
function C:work()
  ...
  local targetPos = playerVehicle and playerVehicle:getPosition() or vec3(self.pinIn.position.value)
  local camRot = quatFromDir(targetPos - camPos, vecUp)
