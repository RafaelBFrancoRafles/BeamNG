...
function C:drawCustom()
  ...
  if im.Button("Preview Position and Rotation") then
		core_camera.setPosRot(0, self.position.x, self.position.y, self.position.z, self.rotation.x, self.rotation.y, self.rotation.z, self.rotation.w)
	end
